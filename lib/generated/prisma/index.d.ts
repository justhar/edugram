...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "globalChat" | "post" | "comment" | "session" | "account" | "verification"
    ...
    model: {
      ...
      GlobalChat: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.GlobalChatFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.GlobalChatAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type GlobalChatOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "message" | "sender" | "createdAt", ExtArgs["result"]["globalChat"]>
  ...
  export interface GlobalChatDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more GlobalChats that matches the filter.
     * @param {GlobalChatFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const globalChat = await prisma.globalChat.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: GlobalChatFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a GlobalChat.
     * @param {GlobalChatAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const globalChat = await prisma.globalChat.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: GlobalChatAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface GlobalChatFieldRefs {
    ...
    readonly message: FieldRef<"GlobalChat", 'String'>
    readonly sender: FieldRef<"GlobalChat", 'String'>
    readonly createdAt: FieldRef<"GlobalChat", 'DateTime'>
  }
   ...
   * GlobalChat findRaw
   */
  export type GlobalChatFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * GlobalChat aggregateRaw
   */
  export type GlobalChatAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type GlobalChatWhereInput = {
    ...
    message?: StringFilter<"GlobalChat"> | string
    sender?: StringFilter<"GlobalChat"> | string
    createdAt?: DateTimeFilter<"GlobalChat"> | Date | string
  }
  ...
  export type GlobalChatScalarWhereWithAggregatesInput = {
    ...
    message?: StringWithAggregatesFilter<"GlobalChat"> | string
    sender?: StringWithAggregatesFilter<"GlobalChat"> | string
    createdAt?: DateTimeWithAggregatesFilter<"GlobalChat"> | Date | string
  }
